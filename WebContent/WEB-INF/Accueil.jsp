...
<h5><a href="/Pilotes/NewVol" style="color:black; padding-left:10px;">Enregistrement vols </a></h5>
...
<h1 style="text-align:center; color:white;">Bienvenue sur le site de<br><img src="http://localhost:8080/Pilotes/fly2.png" width="160" height="60">!</h1>

<div id="im1" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="http://localhost:8080/Pilotes/avion.jpg" alt="First slide">
    </div>
