...
<h5><a href="/Pilotes/listevol" class="btn btn-link btn-lg disabled" role="button" aria-disabled="true" style="color:black; padding-left:10px;">Liste des Vols </a></h5>
...
<h1 style="text-align:center; color:white;">Liste des vols:</h1>
<table class="table">
  ...
  <c:forEach items="${vol}" var="vol">
    <tr>
      <th scope="row" style="color:white;">${vol.idVol}</th>
      <td style="color:white;">${vol.dateVol}</td>
      <td style="color:white;">${vol.pilote.idPilote} ${vol.pilote.nom} ${vol.pilote.prenom}</td>
